<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
      <li class="nav-item nav-profile border-bottom">
        <a href="/view-client-profile" class="nav-link flex-column">
      ...
      <li class="pt-2 pb-1">
        <span class="nav-item-head">History</span>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="cars">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item">
              <a class="nav-link" href="#">Car1</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#">Car2</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#">Car3</a>
            </li>
          </ul>
        </div>
      </li>
      <li class="pt-2 pb-1">
        <a class="nav-link" href="/client-logout" aria-expanded="false">
            <i class="mdi mdi-crosshairs-gps menu-icon"></i>
