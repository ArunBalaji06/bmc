...
<form class="mx-1 mx-md-4" method="post" action="/update-owner-profile" enctype="multipart/form-data">
  ...
  <div class="d-flex flex-row align-items-center mb-4">
    ...
    <div class="form-outline flex-fill mb-0">
      <img src="/owner/profile-image/{{$detail->owner_image}}" height="70" width="70">
      <input type="file" value="{{$detail->owner_image}}" name="photo" class="form-control" />
  ...
  <div class="d-flex flex-row align-items-center mb-4">
    <i class="fas fa-key fa-lg me-3 fa-fw"></i>
    <div class="form-outline flex-fill mb-0">
      <input type="file" value="{{$proof->owner_proof_front}}" name="owner_proof_front" class="form-control" />
  ...
  <div class="d-flex flex-row align-items-center mb-4">
    <i class="fas fa-key fa-lg me-3 fa-fw"></i>
    <div class="form-outline flex-fill mb-0">
      <input type="file" value="{{$proof->owner_proof_back}}" name="owner_proof_back" class="form-control" />
      <label class="form-label" for="form3Example4cd">Owner Proof Front</label>
    </div>
  </div>
